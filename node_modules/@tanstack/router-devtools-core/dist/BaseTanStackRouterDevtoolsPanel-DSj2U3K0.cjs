...
var BaseTanStackRouterDevtoolsPanel = function BaseTanStackRouterDevtoolsPanel({ ...props }) {
	...
	if ("subscribe" in router().stores.pendingMatchesSnapshot) {
		const [_pendingMatches, setPendingMatches] = require_context.createSignal([]);
		pendingMatches = _pendingMatches;
		const [_cachedMatches, setCachedMatches] = require_context.createSignal([]);
...
//# sourceMappingURL=BaseTanStackRouterDevtoolsPanel-DSj2U3K0.cjs.map